...
def banner():
	...
	print("%s║%s  Github   : https://github.com/abirahmed20  %s║"%(Z,B,Z))
	print("%s║%s  Telegram : https://t.me/modapkhouse      %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s0.0                        %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
	xox('            %s》%s》%s》%sZ-CRACK%s《%s《%s《'%(M,H,B,H,B,H,M))
	print("")
